...
# BD: modified the following due to issues/bugs with distributed data parallel on local setup
...
train_loader = DataLoader(train_data, num_workers=0, batch_size=batch_size, shuffle=False, pin_memory=True,
                          sampler=train_sampler)
test_loader = DataLoader(test_data, num_workers=0, batch_size=batch_size, shuffle=False, pin_memory=False)
valid_loader = DataLoader(valid_data, num_workers=0, batch_size=batch_size, shuffle=False, pin_memory=True,
