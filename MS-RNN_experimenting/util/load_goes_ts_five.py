...
def load_GOES_ts_five():
    train_data = GOES_ts_five(train = True, seq_len = cfg.in_len + cfg.out_len)     # make sure seq_len is below 18 (for test_set_5)
    test_data = GOES_ts_five(train = False, seq_len = cfg.in_len + cfg.eval_len)
